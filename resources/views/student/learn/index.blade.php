    ...
    @else
        ...
        <div
            ...
            <div class="grid h-full max-w-lg mx-auto font-medium">
                <form class="grid"
                    action="{{ route('learn.storeUserLearnedCourse', $course->module->first()->slug) }}" method="post">
                    @csrf
                    <button
                        class="inline-flex flex-col items-center justify-center px-5 hover:bg-gray-50 dark:hover:bg-gray-800 group">
                        <x-heroicon-o-arrow-long-right class="w-5 h-5" />
                        <span
                            class="text-sm text-gray-500 dark:text-gray-400 group-hover:text-blue-600 dark:group-hover:text-blue-500">Mulai
                            Belajar</span>
                    </button>
                </form>
            </div>
