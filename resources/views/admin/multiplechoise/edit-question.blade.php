<x-app-layout>
    <div class="flex items-center justify-between">
        ...
        <form action="{{ route('multiplechoise.destroyQuestion', $choise->id) }}" method="post">
            @csrf
            @method('DELETE')
            <x-button.small-danger type="submit" value="{{ $choise->id }}" class="flex items-center gap-1">
                <span>Hapus Soal</span>
            </x-button.small-danger>
        </form>
    </div>
    @if ($errors->all())
    ...
    @endif
    <form x-data="{ answer: '{{ $choise->answer }}' }" method="post" action="{{ route('multiplechoise.updateQuestion', $class->id) }}">
        @csrf
        @method('put')
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input value="{{ $choise->question }}" type="text" id="question"
            ...
            <div>
                ...
                <input type="text" id="option1"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="option1" value="{{ $choise->option1 }}" required>
            </div>
            <div>
                ...
                <input type="text" id="option2"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="option2" value="{{ $choise->option2 }}" required>
            </div>
            <div>
                ...
                <input type="text" id="option3"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="option3" value="{{ $choise->option3 }}" require>
            </div>
            <div>
                ...
                <input type="text" id="option4"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    name="option4" value="{{ $choise->option4 }}" require>
            </div>
            <div>
                <label for="answer"
