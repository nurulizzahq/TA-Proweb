...
<x-app-layout>
    ...
    @endif
    <form action="{{ route('module.update', $module->slug) }}" method="post">
        @method('PUT')
        @csrf
        <div class="grid gap-6 mb-6 md:grid-cols-1">
            ...
            <div>
                <label for="helper-text" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Link
                    Video</label>
                <input type="url" id="url" name="yt_link" value="{{ $module->yt_link }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
            ...
            <div>
                ...
                <textarea type="text" id="content" name="content" aria-describedby="content-explanation"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">{{ $module->content }}</textarea>
            </div>
