<x-app-layout>
                ...
                <div class="relative w-full max-w-md max-h-full">
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <h3 class="mb-5 text-lg font-normal text-gray-600 dark:text-gray-400">Apakah kamu ingin
                                menghapus
                                Modul ini?</h3>
    ...
    @if ($module->yt_link !== null)
        <section>
            <iframe class="w-full mx-auto mb-4" height="400" src="{{ $module->yt_link }}" title="YouTube video player"
                frameborder="0"
