        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input type="text" id="name" name="name"
                    ...
                    placeholder="PTIK 100" value="{{ $room->name }}" required>
            </div>
            <div>
                ...
                <textarea type="text" id="description" name="description"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Kumpul tugasnya ya, jangan lupa!" required>{{ $room->description }}</textarea>
            </div>
            ...
            <div>
                ...
                <input type="number" id="pass_code" name="pass_code" maxlength="4"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="12345" required value="{{ $room->pass_code }}">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input datepicker type="text" name="closed_at"
                        ...
                        placeholder="Select date" value="{{ date('m/d/yyyy', strtotime($room->closed_at)) }}">
                </div>
