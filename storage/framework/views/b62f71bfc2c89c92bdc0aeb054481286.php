...
<?php endif; ?>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <div class="flex flex-row justify-center">
                        <form action="<?php echo e(route('courses.destroy', $course->slug)); ?>" method="post">
                            <?php echo csrf_field(); ?>
    ...
    <form action="<?php echo e(route('courses.update', $course->slug)); ?>" method="post" enctype="multipart/form-data">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                    Kelas</label>
                <input type="text" id="name" name="name" value="<?php echo e($course->name); ?>"
            ...
            <div>
                ...
                <textarea type="text" id="description" name="description"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Belajar Fundamental Javascript untuk membuat web menjadi interaktif" required><?php echo e($course->description); ?></textarea>
            </div>
            ...
            <div>
                ...
                <select autocomplete="off" id="categories" name="course_category_id"
                    ...
                    <?php $__currentLoopData = $categories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $category): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <option <?php if($category->id == $course->course_category_id): echo 'selected'; endif; ?> value="<?php echo e($category->id); ?>">
            ...
            <div class="mb-6">
                <img src="<?php echo e(asset('assets/images/thumbnails/' . $course->thumbnail)); ?>" alt="Thumbnail"
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/admin/courses/edit.blade.php ENDPATH**/ ?>