                ...
                <?php $__currentLoopData = $assignments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $assignment): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700">
                        <th scope="row"
                            ...
                            <?php echo e($assignment->room->name); ?>
                        ...
                        <th scope="row"
                            ...
                            <?php if(now() >= $assignment->room->closed_at): ?>
                                <span
                                    class="text-red-500"><?php echo e(date('d-m-Y', strtotime($assignment->room->closed_at))); ?></span>
                            <?php else: ?>
                                <span
                                    class="text-green-500"><?php echo e(date('d-m-Y', strtotime($assignment->room->closed_at))); ?></span>
                            <?php endif; ?>
                        </th>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['class' => 'w-5 h-5 stroke-red-500']); ?>
<?php echo $__env->renderComponent(); ?>
<?php endif; ?>
...
<?php endif; ?>
                        ...
                        <td class="flex gap-2 px-6 py-4">
                            <?php if($assignment->student_assignment_id != null): ?>
                                <a href="<?php echo e(route('collectAssignmentSended', $assignment->slug)); ?>"
                                    class="font-medium text-blue-600 dark:text-blue-500 hover:underline">Lihat</a>
                            <?php else: ?>
                                <a href="<?php echo e(route('collectAssignment', $assignment->slug)); ?>"
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/student/assignments/index.blade.php ENDPATH**/ ?>