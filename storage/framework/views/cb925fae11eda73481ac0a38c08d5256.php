...
<?php $component->withAttributes([]); ?>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-6 text-center">
                    ...
                    <h3 class="text-lg font-normal text-gray-600 dark:text-gray-400">Apakah kamu ingin menghapus
                        Ruangan ini?</h3>
                    <p class="mb-5 text-xs font-light text-center text-slate-500">Dengan menghapus ruangan ini maka
                        tugas-tugas
                        terkait juga
                        akan
                        dihapus!</p>
    ...
    <form action="<?php echo e(route('rooms.update', $room->slug)); ?>" method="post">
        <?php echo csrf_field(); ?>
        ...
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                ...
                <input type="text" id="name" name="name"
                    ...
                    placeholder="PTIK 100" value="<?php echo e($room->name); ?>" required>
            </div>
            <div>
                ...
                <textarea type="text" id="description" name="description"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Kumpul tugasnya ya, jangan lupa!" required><?php echo e($room->description); ?></textarea>
            </div>
            ...
            <div>
                ...
                <input type="number" id="pass_code" name="pass_code" maxlength="4"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="12345" required value="<?php echo e($room->pass_code); ?>">
            ...
            <div>
                ...
                <div class="relative">
                    ...
                    <input datepicker type="text" name="closed_at"
                        ...
                        placeholder="Select date" value="<?php echo e(date('m/d/yyyy', strtotime($room->closed_at))); ?>">
                </div>
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/lecturer/rooms/edit.blade.php ENDPATH**/ ?>