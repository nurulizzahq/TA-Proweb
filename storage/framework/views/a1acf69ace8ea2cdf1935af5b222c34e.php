...
<?php $component->withAttributes([]); ?>
    <div class="mb-5">
        <h1 class="text-2xl font-bold">Masuk Ruangan: <?php echo e($room->name); ?></h1>
...
<?php endif; ?>
        ...
        <?php endif; ?>
        <form action="<?php echo e(route('enteredRoom', $room->slug)); ?>" method="post">
            <?php echo csrf_field(); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['type' => 'submit','class' => 'w-full -mt-5']); ?>Masuk <?php echo $__env->renderComponent(); ?>
<?php endif; ?>
<?php if (isset($__componentOriginal71c6471fa76ce19017edc287b6f4508c)): ?>
<?php $component = $__componentOriginal71c6471fa76ce19017edc287b6f4508c; ?>
<?php unset($__componentOriginal71c6471fa76ce19017edc287b6f4508c); ?>
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/student/assignments/enter-room.blade.php ENDPATH**/ ?>