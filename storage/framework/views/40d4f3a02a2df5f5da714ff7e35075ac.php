...
<?php $component->withAttributes([]); ?>
    ...
    <?php endif; ?>
    <form action="<?php echo e(route('lecturerCourse.storeReview', $course->slug)); ?>" method="post">
        <?php echo csrf_field(); ?>
        <div class="grid gap-6 mb-6 md:grid-cols-2">
            <div>
                <label for="name" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Nama
                    Kelas</label>
                <input value="<?php echo e($course->name); ?>" disabled type="text" id="name" name="name"
            ...
            <div>
                <label for="slug" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Unik
                    Slug:</label>
                <input value="<?php echo e($course->slug); ?>" disabled type="text" id="slug" name="slug"
                    class="bg-gray-300 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                    placeholder="Belajar Fundamental Javascript" required>
            </div>
        </div>
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/lecturer/courses/send-review.blade.php ENDPATH**/ ?>