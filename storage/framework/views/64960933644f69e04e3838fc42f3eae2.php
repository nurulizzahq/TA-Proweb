...
<?php $component->withAttributes([]); ?>
    <div class="flex justify-end">
        <a href="<?php echo e(route('module.edit', $module->slug)); ?>"
                    ...
                    <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                        ...
                        <div class="p-6 text-center">
                            ...
                            <div class="flex flex-row justify-center">
                                <form action="<?php echo e(route('module.destroy', $module->slug)); ?>" method="post">
                                    <?php echo csrf_field(); ?>
    ...
    <?php if($module->yt_link !== null): ?>
        <section>
            <iframe class="w-full mx-auto mb-4" height="400" src="<?php echo e($module->yt_link); ?>" title="YouTube video player"
                frameborder="0"
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/admin/modules/show.blade.php ENDPATH**/ ?>