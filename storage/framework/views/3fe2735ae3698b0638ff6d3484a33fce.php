...
<?php $component->withAttributes([]); ?>
    <div class="mb-5">
        <h1 class="text-2xl font-bold">Hasil Latihan Soal: <?php echo e($data->name); ?></h1>
...
<?php endif; ?>
    ...
    <section class="px-4 py-2 my-2 rounded bg-slate-100">
        <div class="flex flex-col items-center justify-center h-52">
            ...
            <p class="text-3xl font-bold"><?php echo e($data->examResults[0]->score); ?></p>
        </div>
    </section>
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/student/exam/result.blade.php ENDPATH**/ ?>