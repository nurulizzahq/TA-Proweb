...
<?php $component = Illuminate\View\AnonymousComponent::resolve(['view' => 'components.button.small-primary','data' => ['href' => ''.e(route('module.create', $course->slug)).'','class' => 'flex items-center gap-1']] + (isset($attributes) && $attributes instanceof Illuminate\View\ComponentAttributeBag ? (array) $attributes->getIterator() : [])); ?>
...
<?php $attributes = $attributes->except(collect($constructor->getParameters())->map->getName()->all()); ?>
<?php endif; ?>
<?php $component->withAttributes(['href' => ''.e(route('module.create', $course->slug)).'','class' => 'flex items-center gap-1']); ?>
...
<?php endif; ?>
                        ...
                        <td class="flex gap-2 px-6 py-4">
                            <a href="<?php echo e(route('module.show', $module->slug)); ?>"
...
<?php endif; ?>
<?php /**PATH /Users/nurulizzahq/Documents/proweb/proweb/resources/views/admin/modules/index.blade.php ENDPATH**/ ?>